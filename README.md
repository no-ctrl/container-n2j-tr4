...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-n2j-tr4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-n2j-tr4.containers.anotherwebservice.com/
...
```
git clone git@github.com:no-ctrl/container-n2j-tr4.git
cd container-n2j-tr4
```
...
```
docker attach container-n2j-tr4
```
